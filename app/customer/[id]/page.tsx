...
export default function CustomerDetailPage() {
  ...
  // 부모 행은 소속 업체를 묶기만 하는 껍데기다(주소·장비·견적이 없다).
  // 일반 상세를 그대로 보여주면 빈 화면이 되므로, 무엇인지 알려주고 소속 업체만 낸다.
